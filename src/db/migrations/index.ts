...
const migration0000 = `CREATE TABLE \`users\` (
...
CREATE INDEX \`users_updated_at_idx\` ON \`users\` (\`updated_at_iso\`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX \`locations_user_city_idx\` ON \`locations\` (\`user_id\`,\`city\`);
--> statement-breakpoint
CREATE INDEX \`locations_user_visited_idx\` ON \`locations\` (\`user_id\`,\`visited_at_iso\`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX \`friendships_user_b_status_idx\` ON \`friendships\` (\`user_b_id\`,\`status\`);
--> statement-breakpoint
